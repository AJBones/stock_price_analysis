...
ftse_100 = pd.read_csv(ftse_250_path)
...
price_data_100.to_csv("../data/ftse_100_historic_prices.csv")
...
for i in range(len(ftse_250)):
    ...
    data.reset_index(inplace=True)
    price_data = pd.concat([price_data_250, data], axis=0, ignore_index=True)
price_data_250.to_csv("../data/ftse_250_historic_prices.csv")
